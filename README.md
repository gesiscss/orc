...
BinderHub (with `jupyter/repo2docker:5cdd0ee`) runs under https://notebooks.gesis.org/binder/. 

Chart version [0.1.0-80ac52c](https://github.com/jupyterhub/binderhub/tree/80ac52c)
