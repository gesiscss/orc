...
BinderHub (with `jupyter/repo2docker:746e4d92`) runs under https://notebooks.gesis.org/binder/. 

Chart version [0.2.0-1eac3a0](https://github.com/jupyterhub/binderhub/tree/1eac3a0)
