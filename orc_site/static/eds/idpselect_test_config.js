...
function IdPSelectUIParms(){
    ...
    this.defaultLogo = '/static/images/logo/logo.svg';
    this.defaultLogoWidth = 100;
    this.defaultLogoHeight = 100;
    // If non null, then the default place to send users who are not
    // Approaching via the Discovery Protocol for example
    this.defaultReturn = 'https://notebooks-test.gesis.org/Shibboleth.sso/Login?SAMLDS=1&target=https://notebooks-test.gesis.org/jupyter/hub/login';
    ...
    // If non null then this string must match the string provided in the DS parms
    this.myEntityID = 'https://notebooks-test.gesis.org/shibboleth';
